...
export function AssortedShapes() {
    ...
    let shapes = [
        ...
        new Sphere(new Vector(-1, 1, 2), 1, new Appearance(Color.Green, new Finish({shiny: 0.8}))),
        new Sphere(new Vector(-2, 2, 5), 2, new Appearance(Color.Blue, new Finish({shiny: 0.5}))),
    ];
    return new Scene(camera, background, shapes, lights);
}
