---
title: "1.5: Rays, Scenes, and the Camera"
layout: module
nav_order: 5
summary: >
...
{% include_relative jstracer-part01/jstracer/modules/settings.js %}
```
...
{% include_relative jstracer-part01/jstracer/modules/ray.js %}
```
...
{% include_relative jstracer-part01/jstracer/modules/scene.js %}
```
...
{% include_relative jstracer-part01/jstracer/modules/camera.js %}
```
